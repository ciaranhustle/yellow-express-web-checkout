...
export const AddressAutocomplete: React.FC<Props> = ({ placeholder, value, onChange }) => {
	const handleChange = async (address: Address | null) => {
		...
		if (!postcodeComponent || !postcodes.includes(parseInt(postcodeComponent.long_name))) {
